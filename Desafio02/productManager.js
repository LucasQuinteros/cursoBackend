...
class ProductManager{
    ...
    async getProductById( idBuscado){
        ...
        if (!p) console.log(`(getProductById)Error no se encontro el producto con id ${idBuscado}`);
        return p;
    }
...
// Test
let productManager = new ProductManager(JSONPATH);

//productManager.addProduct("producto0","Este es un producto prueba",200,"Sin imagen","abc123",25)
//productManager.addProduct("producto1","Este es un producto prueba",200,"Sin imagen","abc124",50)
//productManager.addProduct("producto2","Este es un producto prueba",200,"Sin imagen","abc125",75)
//productManager.addProduct("producto3","Este es un producto prueba",200,"Sin imagen","abc126",80)
//productManager.addProduct("producto4","Este es un producto prueba",200,"Sin imagen","abc127",80)

//productManager.getProducts().then((p) =>{
//    console.log(p)
//})

//productManager.getProductById(3).then((p) =>{
//    console.log(p)
//
//})
